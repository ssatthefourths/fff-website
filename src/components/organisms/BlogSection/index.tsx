...
import { imgGroup, imgGroup1 } from '../../../imports/svg-9news';
...
function Group1() {
  return (
    <div className="absolute inset-[0.01%_0.13%_0.33%_0.03%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-0.051px_-0.014px] mask-size-[195.76px_167.677px]" style={{ maskImage: `url('${imgGroup1}')` }} data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 195.702 167.66">
        <g id="Group">
          <path d={svgPaths.p36343a00} fill="var(--fill-0, #8B52C5)" id="Vector" />
          <path d={svgPaths.p3be9ea0} fill="var(--fill-0, white)" id="Vector_2" />
          <path d={svgPaths.p1714a200} fill="var(--fill-0, white)" id="Vector_3" />
          <path d={svgPaths.p35c26b60} fill="var(--fill-0, #8B52C5)" id="Vector_4" />
          <path d={svgPaths.p1bff7340} fill="var(--fill-0, #8B52C5)" id="Vector_5" />
        </g>
      </svg>
    </div>
  );
