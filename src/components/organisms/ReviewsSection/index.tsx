...
export function ReviewsSection() {
  ...
  return (
    <div className="relative h-auto min-h-[400px] lg:h-[667px] content-stretch flex gap-4 sm:gap-8 lg:gap-[60px] items-center justify-center px-4 py-12 sm:px-6 md:px-12 md:py-16 lg:px-[80px] lg:py-[120px] w-full overflow-x-clip max-w-[1400px] mx-auto" data-name="REVIEWS SECTION">
      {/* LEFT ARROW */}
